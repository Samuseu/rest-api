...
public class SelenoidTests {
    /*
        ...
        2.Get response // 20240123002759 // https://selenoid.autotests.cloud/status { "total": 20, "used": 0, "queued": 0, "pending": 0,
    ...
    void checkResponseBadPractice(){
        String expectedReponsesString = "{\"total\":20,\"used\":0,\"queued\":0,\"pending\":0,\"browsers\":" +
                "{\"android\":{\"8.1\":{}}," +
                "\"chrome\":{\"100.0\":{},\"99.0\":{}}," +
                "\"chrome-mobile\":{\"86.0\":{}}," +
                "\"firefox\":{\"97.0\":{},\"98.0\":{}}," +
        ...
        assertEquals(expectedReponsesString,actualResponse.asString());
    }
